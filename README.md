...
* [RFdiffusion](https://github.com/RosettaCommons/RFdiffusion) ⭐ 3,040 | 🐛 245 | 🌐 Python | 📅 2026-07-15 - Open-source method for de novo protein design using structure-guided diffusion models.
...
* [QSPRpred](https://github.com/CDDLeiden/QSPRpred) ⭐ 95 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2026-06-26 - Open-source Python toolkit for building, reproducing, and deploying QSAR/QSPR models.
...
* [Mordred](https://github.com/mordred-descriptor/mordred) ⭐ 480 | 🐛 55 | 🌐 Python | 📅 2024-02-07 - Python library with 1800+ molecular descriptors.
...
* [DiffDock](https://github.com/gcorso/DiffDock) ⭐ 1,571 | 🐛 132 | 🌐 Python | 📅 2025-05-02 - Deep learning-based docking tool that predicts ligand poses directly from protein structures using diffusion models.
* [Gnina](https://github.com/gnina/gnina) ⭐ 969 | 🐛 24 | 🌐 C++ | 📅 2026-06-29 - CNN-scoring docking.
...
* [Meeko](https://github.com/forlilab/Meeko) ⭐ 385 | 🐛 49 | 🌐 Python | 📅 2026-08-27 - Prepares ligands/receptors for AutoDock by assigning partial charges and atom types.
...
* [MolScrub](https://github.com/forlilab/molscrub) ⭐ 59 | 🐛 6 | 🌐 Python | 📅 2026-09-02 - Enumerates tautomers, pH states, and conformers for docking and structure-based modeling.
...
* [xyzrender](https://github.com/aligfellow/xyzrender) ⭐ 598 | 🐛 12 | 🌐 Python | 📅 2026-08-13 - CLI for producing publication-quality molecular graphics, GIFs, and SVGs from coordinate files.
...
* [AiZynthFinder](https://github.com/MolecularAI/aizynthfinder) ⭐ 888 | 🐛 9 | 🌐 Python | 📅 2026-04-13 - Monte Carlo tree search-based retrosynthesis using trained neural networks.
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 6,976 | 🐛 1,177 | 🌐 Python | 📅 2026-08-20 - Open-source deep learning framework for chemistry and biology.
* [Chemprop](https://github.com/chemprop/chemprop) ⭐ 2,455 | 🐛 18 | 🌐 Python | 📅 2026-09-01 - Directed message passing neural networks for molecular property prediction.
...
* [Boltz-2](https://github.com/jwohlwend/boltz) ⭐ 4,199 | 🐛 142 | 🌐 Python | 📅 2026-05-29 - A foundation model that jointly predicts structure and binding affinity, rivaling physics-based FEP methods in accuracy.
* [ESM3](https://github.com/evolutionaryscale/esm) ⭐ 2,940 | 🐛 67 | 🌐 Jupyter Notebook | 📅 2026-09-03 - Generative biology foundation model for designing novel proteins across sequence, structure, and function.
* [Chai-1](https://github.com/chaidiscovery/chai-lab) ⭐ 1,990 | 🐛 93 | 🌐 Python | 📅 2026-06-30 - Multi-modal foundation model for biomolecular structure prediction of proteins, nucleic acids, and ligands.
...
* [PyChem-Pro](https://github.com/vijaymasand/PyChem-Pro) ⭐ 352 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - Pure-Python desktop application for molecular visualization, geometry optimization, and cheminformatics.
...
* [HEDGEHOG](https://github.com/LigandPro/hedgehog) ⭐ 14 | 🐛 3 | 🌐 Python | 📅 2026-06-22 - Stage-based evaluation pipeline for generative molecular design with filters, retrosynthesis checks, docking, pose validation, and reports.
...
* [AI for Chemistry Course](https://github.com/schwallergroup/ai4chem_course) ⭐ 291 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-04-03 - Lecture slides, Jupyter notebooks, and exercises for machine learning in chemistry.
...
* [DeepChem Tutorials](https://github.com/deepchem/deepchem/tree/master/examples/tutorials) ⭐ 6,976 | 🐛 1,177 | 🌐 Python | 📅 2026-08-20 - Comprehensive set of tutorials covering deep learning for chemistry, biology, and materials science.
* [Practical Cheminformatics Tutorials](https://github.com/PatWalters/practical_cheminformatics_tutorials) ⭐ 1,305 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-08-22 - Hands-on Jupyter tutorials for RDKit, SAR, clustering, generative models, and ML pipelines.
