...
* [RFdiffusion](https://github.com/RosettaCommons/RFdiffusion) ⭐ 3,055 | 🐛 245 | 🌐 Python | 📅 2026-07-15 - Open-source method for de novo protein design using structure-guided diffusion models.
...
* [Morfeus](https://github.com/digital-chemistry-laboratory/morfeus) ⭐ 236 | 🐛 9 | 🌐 Python | 📅 2026-09-02 - Python package for calculating 3D steric and electronic parameters of molecules.
...
* [Gnina](https://github.com/gnina/gnina) ⭐ 977 | 🐛 24 | 🌐 C++ | 📅 2026-06-29 - CNN-scoring docking.
...
* [xyzrender](https://github.com/aligfellow/xyzrender) ⭐ 611 | 🐛 13 | 🌐 Python | 📅 2026-08-13 - CLI for producing publication-quality molecular graphics, GIFs, and SVGs from coordinate files.
...
* [Pharmacon](https://github.com/k-georgiou/pharmacon) ⭐ 24 | 🐛 0 | 🌐 Python | 📅 2026-07-14 - Open-source toolkit for molecular dynamics simulation analysis in medicinal chemistry.
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 7,009 | 🐛 1,183 | 🌐 Python | 📅 2026-08-20 - Open-source deep learning framework for chemistry and biology.
...
* [Boltz-2](https://github.com/jwohlwend/boltz) ⭐ 4,214 | 🐛 136 | 🌐 Python | 📅 2026-05-29 - A foundation model that jointly predicts structure and binding affinity, rivaling physics-based FEP methods in accuracy.
* [ESM3](https://github.com/evolutionaryscale/esm) ⭐ 2,972 | 🐛 71 | 🌐 Jupyter Notebook | 📅 2026-09-16 - Generative biology foundation model for designing novel proteins across sequence, structure, and function.
...
* [PyChem-Pro](https://github.com/vijaymasand/PyChem-Pro) ⭐ 360 | 🐛 1 | 🌐 Python | 📅 2026-09-18 - Pure-Python desktop application for molecular visualization, geometry optimization, and cheminformatics.
...
* [NAMI](https://github.com/mqcomplab/NAMI) ⭐ 28 | 🐛 1 | 🌐 Python | 📅 2026-09-18 - Computational tool for clustering and evaluating differences across molecular datasets.
...
* [DeepChem Tutorials](https://github.com/deepchem/deepchem/tree/master/examples/tutorials) ⭐ 7,009 | 🐛 1,183 | 🌐 Python | 📅 2026-08-20 - Comprehensive set of tutorials covering deep learning for chemistry, biology, and materials science.
* [Practical Cheminformatics Tutorials](https://github.com/PatWalters/practical_cheminformatics_tutorials) ⭐ 1,311 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-08-22 - Hands-on Jupyter tutorials for RDKit, SAR, clustering, generative models, and ML pipelines.
