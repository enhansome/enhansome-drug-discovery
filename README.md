...
* [Gnina](https://github.com/gnina/gnina) ⭐ 975 | 🐛 24 | 🌐 C++ | 📅 2026-06-29 - CNN-scoring docking.
...
* [Chemprop](https://github.com/chemprop/chemprop) ⭐ 2,467 | 🐛 20 | 🌐 Python | 📅 2026-09-01 - Directed message passing neural networks for molecular property prediction.
...
* [Boltz-2](https://github.com/jwohlwend/boltz) ⭐ 4,211 | 🐛 136 | 🌐 Python | 📅 2026-05-29 - A foundation model that jointly predicts structure and binding affinity, rivaling physics-based FEP methods in accuracy.
* [ESM3](https://github.com/evolutionaryscale/esm) ⭐ 2,964 | 🐛 68 | 🌐 Jupyter Notebook | 📅 2026-09-16 - Generative biology foundation model for designing novel proteins across sequence, structure, and function.
...
* [Uni-Mol](https://github.com/dptech-corp/Uni-Mol) ⭐ 1,160 | 🐛 113 | 🌐 Python | 📅 2025-05-29 - 3D molecular representation learning framework.
