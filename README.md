...
* [RFdiffusion](https://github.com/RosettaCommons/RFdiffusion) ⭐ 3,012 | 🐛 245 | 🌐 Python | 📅 2026-07-15 - Open-source method for de novo protein design using structure-guided diffusion models.
* [PDBFixer](https://github.com/openmm/pdbfixer) ⭐ 668 | 🐛 59 | 🌐 Python | 📅 2026-03-10 - Repairs PDB files by adding missing atoms, residues, and hydrogens for MD simulations.
...
* [QSPRpred](https://github.com/CDDLeiden/QSPRpred) ⭐ 93 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2026-06-26 - Open-source Python toolkit for building, reproducing, and deploying QSAR/QSPR models.
...
* [Mordred](https://github.com/mordred-descriptor/mordred) ⭐ 476 | 🐛 55 | 🌐 Python | 📅 2024-02-07 - Python library with 1800+ molecular descriptors.
...
* [DiffDock](https://github.com/gcorso/DiffDock) ⭐ 1,564 | 🐛 132 | 🌐 Python | 📅 2025-05-02 - Deep learning-based docking tool that predicts ligand poses directly from protein structures using diffusion models.
* [Gnina](https://github.com/gnina/gnina) ⭐ 961 | 🐛 25 | 🌐 C++ | 📅 2026-06-29 - CNN-scoring docking.
* [AutoDock-GPU](https://github.com/ccsb-scripps/AutoDock-GPU) ⭐ 606 | 🐛 87 | 🌐 C++ | 📅 2026-08-11 - GPU-accelerated version of AutoDock for faster ligand-receptor docking.
* [Meeko](https://github.com/forlilab/Meeko) ⭐ 384 | 🐛 50 | 🌐 Python | 📅 2026-08-08 - Prepares ligands/receptors for AutoDock by assigning partial charges and atom types.
* [Smina](https://github.com/mwojcikowski/smina) ⭐ 147 | 🐛 0 | 🌐 C++ | 📅 2018-11-18 - Vina fork with extra features.
* [PandaDock](https://github.com/pritampanda15/PandaDock) ⭐ 99 | 🐛 0 | 🌐 Python | 📅 2026-08-04 - Python docking tool.
* [EasyDock](https://github.com/ci-lab-cz/easydock) ⭐ 83 | 🐛 13 | 🌐 Python | 📅 2026-06-17 - Vina/Smina pipeline.
* [MolScrub](https://github.com/forlilab/molscrub) ⭐ 57 | 🐛 6 | 🌐 Python | 📅 2026-08-08 - Enumerates tautomers, pH states, and conformers for docking and structure-based modeling.
* [MzDOCK](https://github.com/Muzatheking12/MzDOCK) ⭐ 27 | 🐛 11 | 🌐 Python | 📅 2025-09-02 - GUI docking pipeline.
...
* [xyzrender](https://github.com/aligfellow/xyzrender) ⭐ 584 | 🐛 13 | 🌐 Python | 📅 2026-07-31 - CLI for producing publication-quality molecular graphics, GIFs, and SVGs from coordinate files.
...
* [Pharmacon](https://github.com/k-georgiou/pharmacon) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2026-07-14 - Open-source toolkit for molecular dynamics simulation analysis in medicinal chemistry.
...
* [AiZynthFinder](https://github.com/MolecularAI/aizynthfinder) ⭐ 878 | 🐛 9 | 🌐 Python | 📅 2026-04-13 - Monte Carlo tree search-based retrosynthesis using trained neural networks.
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 6,939 | 🐛 1,159 | 🌐 Python | 📅 2026-08-10 - Open-source deep learning framework for chemistry and biology.
* [Chemprop](https://github.com/chemprop/chemprop) ⭐ 2,434 | 🐛 13 | 🌐 Python | 📅 2026-08-04 - Directed message passing neural networks for molecular property prediction.
* [DGL-LifeSci](https://github.com/awslabs/dgl-lifesci) ⭐ 808 | 🐛 32 | 🌐 Python | 📅 2023-11-01 - Graph deep learning toolkit for life sciences using the Deep Graph Library.
...
* [ChemML](https://github.com/hachmannlab/chemml) ⭐ 180 | 🐛 4 | 🌐 Python | 📅 2026-08-11 - Machine learning and informatics suite for analyzing, mining, and modeling chemical and materials data.
...
* [Boltz-2](https://github.com/jwohlwend/boltz) ⭐ 4,159 | 🐛 155 | 🌐 Python | 📅 2026-05-29 - A foundation model that jointly predicts structure and binding affinity, rivaling physics-based FEP methods in accuracy.
* [ESM3](https://github.com/evolutionaryscale/esm) ⭐ 2,899 | 🐛 71 | 🌐 Jupyter Notebook | 📅 2026-07-28 - Generative biology foundation model for designing novel proteins across sequence, structure, and function.
* [Chai-1](https://github.com/chaidiscovery/chai-lab) ⭐ 1,977 | 🐛 93 | 🌐 Python | 📅 2026-06-30 - Multi-modal foundation model for biomolecular structure prediction of proteins, nucleic acids, and ligands.
* [Uni-Mol](https://github.com/dptech-corp/Uni-Mol) ⭐ 1,145 | 🐛 112 | 🌐 Python | 📅 2025-05-29 - 3D molecular representation learning framework.
...
* [cleanmol](https://github.com/nurtilekgalimov/cleanmol) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2026-04-15 - Python library for cleaning, standardizing, and preparing molecular structures for cheminformatics workflows.

## Utility and Workflow Tools

* [chembl\_webresource\_client](https://github.com/chembl/chembl_webresource_client) ⭐ 448 | 🐛 29 | 🌐 Python | 📅 2026-03-24 - Official Python client library for programmatic access to the ChEMBL database API.
* [PyChem-Pro](https://github.com/vijaymasand/PyChem-Pro) ⭐ 330 | 🐛 4 | 🌐 Python | 📅 2026-08-11 - Pure-Python desktop application for molecular visualization, geometry optimization, and cheminformatics.
...
* [AI for Chemistry Course](https://github.com/schwallergroup/ai4chem_course) ⭐ 288 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-04-03 - Lecture slides, Jupyter notebooks, and exercises for machine learning in chemistry.
...
* [Awesome Learning Digital Chemistry](https://github.com/mlederbauer/awesome-learning-digital-chemistry) ⭐ 49 | 🐛 5 | 📅 2026-01-25 - Curated compilation of resources for learning digital chemistry, including courses, tutorials, and books.
...
* [DeepChem Tutorials](https://github.com/deepchem/deepchem/tree/master/examples/tutorials) ⭐ 6,939 | 🐛 1,159 | 🌐 Python | 📅 2026-08-10 - Comprehensive set of tutorials covering deep learning for chemistry, biology, and materials science.
* [Practical Cheminformatics Tutorials](https://github.com/PatWalters/practical_cheminformatics_tutorials) ⭐ 1,292 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-05-02 - Hands-on Jupyter tutorials for RDKit, SAR, clustering, generative models, and ML pipelines.
...
* [how-to-train-your-chemeleon](https://github.com/JacksonBurns/how-to-train-your-chemeleon) ⭐ 12 | 🐛 0 | 🌐 Python | 📅 2026-07-06 - Tutorial and framework for training chemical machine learning models.
