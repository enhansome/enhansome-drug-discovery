...
* [RFdiffusion](https://github.com/RosettaCommons/RFdiffusion) ⭐ 3,028 | 🐛 245 | 🌐 Python | 📅 2026-07-15 - Open-source method for de novo protein design using structure-guided diffusion models.
...
* [Meeko](https://github.com/forlilab/Meeko) ⭐ 386 | 🐛 48 | 🌐 Python | 📅 2026-08-27 - Prepares ligands/receptors for AutoDock by assigning partial charges and atom types.
...
* [Chemprop](https://github.com/chemprop/chemprop) ⭐ 2,442 | 🐛 15 | 🌐 Python | 📅 2026-08-21 - Directed message passing neural networks for molecular property prediction.
...
* [Boltz-2](https://github.com/jwohlwend/boltz) ⭐ 4,186 | 🐛 152 | 🌐 Python | 📅 2026-05-29 - A foundation model that jointly predicts structure and binding affinity, rivaling physics-based FEP methods in accuracy.
* [ESM3](https://github.com/evolutionaryscale/esm) ⭐ 2,933 | 🐛 74 | 🌐 Jupyter Notebook | 📅 2026-08-27 - Generative biology foundation model for designing novel proteins across sequence, structure, and function.
...
* [Practical Cheminformatics Tutorials](https://github.com/PatWalters/practical_cheminformatics_tutorials) ⭐ 1,302 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-08-22 - Hands-on Jupyter tutorials for RDKit, SAR, clustering, generative models, and ML pipelines.
