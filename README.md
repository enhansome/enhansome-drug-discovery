...
* [RFdiffusion](https://github.com/RosettaCommons/RFdiffusion) ⭐ 3,030 | 🐛 245 | 🌐 Python | 📅 2026-07-15 - Open-source method for de novo protein design using structure-guided diffusion models.
* [PDBFixer](https://github.com/openmm/pdbfixer) ⭐ 672 | 🐛 60 | 🌐 Python | 📅 2026-03-10 - Repairs PDB files by adding missing atoms, residues, and hydrogens for MD simulations.
...
* [Gnina](https://github.com/gnina/gnina) ⭐ 966 | 🐛 24 | 🌐 C++ | 📅 2026-06-29 - CNN-scoring docking.
...
* [EasyDock](https://github.com/ci-lab-cz/easydock) ⭐ 84 | 🐛 13 | 🌐 Python | 📅 2026-08-21 - Vina/Smina pipeline.
* [MolScrub](https://github.com/forlilab/molscrub) ⭐ 59 | 🐛 6 | 🌐 Python | 📅 2026-08-24 - Enumerates tautomers, pH states, and conformers for docking and structure-based modeling.
...
* [xyzrender](https://github.com/aligfellow/xyzrender) ⭐ 594 | 🐛 12 | 🌐 Python | 📅 2026-08-13 - CLI for producing publication-quality molecular graphics, GIFs, and SVGs from coordinate files.
...
* [AiZynthFinder](https://github.com/MolecularAI/aizynthfinder) ⭐ 884 | 🐛 9 | 🌐 Python | 📅 2026-04-13 - Monte Carlo tree search-based retrosynthesis using trained neural networks.
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 6,969 | 🐛 1,169 | 🌐 Python | 📅 2026-08-20 - Open-source deep learning framework for chemistry and biology.
* [Chemprop](https://github.com/chemprop/chemprop) ⭐ 2,443 | 🐛 15 | 🌐 Python | 📅 2026-08-21 - Directed message passing neural networks for molecular property prediction.
...
* [Boltz-2](https://github.com/jwohlwend/boltz) ⭐ 4,188 | 🐛 152 | 🌐 Python | 📅 2026-05-29 - A foundation model that jointly predicts structure and binding affinity, rivaling physics-based FEP methods in accuracy.
* [ESM3](https://github.com/evolutionaryscale/esm) ⭐ 2,935 | 🐛 74 | 🌐 Jupyter Notebook | 📅 2026-08-27 - Generative biology foundation model for designing novel proteins across sequence, structure, and function.
* [Chai-1](https://github.com/chaidiscovery/chai-lab) ⭐ 1,988 | 🐛 93 | 🌐 Python | 📅 2026-06-30 - Multi-modal foundation model for biomolecular structure prediction of proteins, nucleic acids, and ligands.
* [Uni-Mol](https://github.com/dptech-corp/Uni-Mol) ⭐ 1,157 | 🐛 113 | 🌐 Python | 📅 2025-05-29 - 3D molecular representation learning framework.
...
* [DeepChem Tutorials](https://github.com/deepchem/deepchem/tree/master/examples/tutorials) ⭐ 6,969 | 🐛 1,169 | 🌐 Python | 📅 2026-08-20 - Comprehensive set of tutorials covering deep learning for chemistry, biology, and materials science.
* [Practical Cheminformatics Tutorials](https://github.com/PatWalters/practical_cheminformatics_tutorials) ⭐ 1,303 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-08-22 - Hands-on Jupyter tutorials for RDKit, SAR, clustering, generative models, and ML pipelines.
