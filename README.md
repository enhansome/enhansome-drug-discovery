...
* [RFdiffusion](https://github.com/RosettaCommons/RFdiffusion) ⭐ 3,016 | 🐛 245 | 🌐 Python | 📅 2026-07-15 - Open-source method for de novo protein design using structure-guided diffusion models.
* [PDBFixer](https://github.com/openmm/pdbfixer) ⭐ 670 | 🐛 60 | 🌐 Python | 📅 2026-03-10 - Repairs PDB files by adding missing atoms, residues, and hydrogens for MD simulations.
...
* [Mordred](https://github.com/mordred-descriptor/mordred) ⭐ 478 | 🐛 55 | 🌐 Python | 📅 2024-02-07 - Python library with 1800+ molecular descriptors.
...
* [Meeko](https://github.com/forlilab/Meeko) ⭐ 385 | 🐛 51 | 🌐 Python | 📅 2026-08-08 - Prepares ligands/receptors for AutoDock by assigning partial charges and atom types.
...
* [MolScrub](https://github.com/forlilab/molscrub) ⭐ 58 | 🐛 7 | 🌐 Python | 📅 2026-08-08 - Enumerates tautomers, pH states, and conformers for docking and structure-based modeling.
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 6,943 | 🐛 1,157 | 🌐 Python | 📅 2026-08-10 - Open-source deep learning framework for chemistry and biology.
...
* [ESM3](https://github.com/evolutionaryscale/esm) ⭐ 2,905 | 🐛 73 | 🌐 Jupyter Notebook | 📅 2026-08-15 - Generative biology foundation model for designing novel proteins across sequence, structure, and function.
...
* [Uni-Mol](https://github.com/dptech-corp/Uni-Mol) ⭐ 1,146 | 🐛 112 | 🌐 Python | 📅 2025-05-29 - 3D molecular representation learning framework.
...
* [PyChem-Pro](https://github.com/vijaymasand/PyChem-Pro) ⭐ 330 | 🐛 4 | 🌐 Python | 📅 2026-08-17 - Pure-Python desktop application for molecular visualization, geometry optimization, and cheminformatics.
...
* [DeepChem Tutorials](https://github.com/deepchem/deepchem/tree/master/examples/tutorials) ⭐ 6,943 | 🐛 1,157 | 🌐 Python | 📅 2026-08-10 - Comprehensive set of tutorials covering deep learning for chemistry, biology, and materials science.
